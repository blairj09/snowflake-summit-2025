...
# Load data
stages <- read_csv(here::here("dashboard", "data", "stages.csv"))

# Querychat config
querychat_config <- querychat_init(
  stages,
  greeting = readLines(here::here("dashboard", "greeting.md")),
  data_description = readLines(here::here("dashboard", "data_description.md"))
)
